...
public class Utils
{
	...
	//ip格式控制
	static private Pattern mPattern = Pattern.compile("[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}");
	...
	static public String getLocalIpAddress(Context context)
	{
		...
		try
		{
			...
			{
				locals = gate.split("\\.");
				if (locals != null && locals.length > 0 && locals[0] != null && !locals[0].equals(""))
				{
					local = locals[0];
				}
			}
	...
	static public String getGateWay(Context context)
	{
		...
		if (context == null)
		{
			DEBUG.log(TAG, "getGateWay context == null");
			return ret;
		}
		WifiManager wifi_service = (WifiManager) context.getSystemService(Service.WIFI_SERVICE);
		if (wifi_service == null)
		{
			DEBUG.log(TAG, "getGateWay wifi_service == null");
			return ret;
		}
		DhcpInfo dhcpinfo = wifi_service.getDhcpInfo();
		if (dhcpinfo == null)
		{
			DEBUG.log(TAG, "getGateWay dhcpinfo == null");
			return ret;
		}
