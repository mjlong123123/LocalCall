...
#ifndef JVOIPSILENCESUPPRESSION_H

#define JVOIPSILENCESUPPRESSION_H
...
class JVOIPSilenceSuppression : public JVOIPCompressionModule
{
public:
	JVOIPSilenceSuppression(JVOIPSession *sess);
	~JVOIPSilenceSuppression();
	...
	static bool IsSilent(VoIPFramework::VoiceBlock *vb);
...
#endif // JVOIPSILENCESUPPRESSION_H
