...
#ifndef JVOIPVOICEOUTPUT_H

#define JVOIPVOICEOUTPUT_H

#include "jvoipconfig.h"
#include "sampleoutput.h"
#include "jvoipcomponent.h"

class JVOIPVoiceOutput : public VoIPFramework::SampleOutput,public JVOIPComponent
{
public:
	JVOIPVoiceOutput(JVOIPSession *sess):JVOIPComponent(sess) { }
	virtual ~JVOIPVoiceOutput() { }
	virtual int Init(int sampinterval,int outputsamprate,int outputbytespersample,bool stereo,const JVOIPComponentParams *componentparams) = 0;
	...
	virtual int SetStereo(bool s) = 0;
};

#endif // JVOIPVOICEOUTPUT_H
